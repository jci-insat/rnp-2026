...
const vendrediEnLigne: PassageEntry[] = [
  ...
  { n: 2, olm: "JCI Sfax", participant: "Emna Moujehed", startup: "Zymotech", zone: "Zone E", time: "17:00", salle: "Salle CYE 2" },
  { n: 3, olm: "JCI Zarzis", participant: "Asma Basly", startup: "OORB — Open Organic Robotics", zone: "Zone E", time: "17:10", salle: "Salle CYE 1" },
  { n: 4, olm: "JCI El Alia", participant: "Mootaz Hammami", startup: "EduHelper", zone: "Zone B", time: "17:10", salle: "Salle CYE 2" },
  { n: 5, olm: "JCI Sbikha", participant: "Hamden Nasri", startup: "Trip Hive Technologies", zone: "Zone D", time: "17:20", salle: "Salle CYE 1" },
  { n: 6, olm: "JCI Ouardanine", participant: "Seddik Houimli", startup: "SupplyzPro", zone: "Zone C", time: "17:20", salle: "Salle CYE 2" },
  { n: 7, olm: "JCI Sousse", participant: "Ichrak Eddor Mnijli", startup: "HeroBee", zone: "Zone C", time: "17:30", salle: "Salle CYE 1" },
  { n: 8, olm: "JCI INSAT Tunis", participant: "Riadh Jouini", startup: "NartaQ", zone: "Zone A", time: "17:30", salle: "Salle CYE 2" },
  { n: 9, olm: "JCI Monastir", participant: "Chouchane Amina", startup: "Karhabti.app", zone: "Zone C", time: "17:40", salle: "Salle CYE 1" },
  { n: 10, olm: "JCI Hammam Sousse", participant: "Moetaz Ben Charrada", startup: "HAIER HR", zone: "Zone C", time: "17:40", salle: "Salle CYE 2" },
  { n: 11, olm: "JCI Hammam Sousse", participant: "Anis Belkahla", startup: "BARBARIJ", zone: "Zone C", time: "17:50", salle: "Salle CYE 1" },
  { n: 12, olm: "JCI Rafraf", participant: "Sarra Soussia", startup: "Save The Plate", zone: "Zone B", time: "17:50", salle: "Salle CYE 2" },
  { n: 13, olm: "JCI Benguerdane", participant: "Faker Chouikhi", startup: "Watcher AI", zone: "Zone E", time: "18:00", salle: "Salle CYE 1" },
  { n: 14, olm: "JCI Carthage", participant: "Yassine Khelifi", startup: "BIOHEAT", zone: "Zone A", time: "18:00", salle: "Salle CYE 2" },
  { n: 15, olm: "JCI Sbikha", participant: "Aziz Ghannem", startup: "AG Afro Solar / Olibueno", zone: "Zone D", time: "18:10", salle: "Salle CYE 1" },
  { n: 16, olm: "JCI Menzel Bourguiba", participant: "Firas Yousfi", startup: "Click and Win", zone: "Zone B", time: "18:10", salle: "Salle CYE 2" },
  { n: 17, olm: "JCI Ghardimaou", participant: "Khouloud Mhamdi", startup: "Arkhou Drone", zone: "Zone B", time: "18:20", salle: "Salle CYE 1" },
  { n: 18, olm: "JCI Ras Jebel", participant: "Mohamed Amine Amara", startup: "Edulylo", zone: "Zone B", time: "18:20", salle: "Salle CYE 2" },
  { n: 19, olm: "JCI Nabeul", participant: "Benameur Helmi", startup: "PEDAGO", zone: "Zone A", time: "18:30", salle: "Salle CYE 1" },
  { n: 20, olm: "JCI UJ Jendouba", participant: "Ameni", startup: "KIDDOS", zone: "Zone B", time: "18:30", salle: "Salle CYE 2" },
  { n: 21, olm: "JCI UJ Jendouba", participant: "Ala Eddine Dhaouafi", startup: "Melleya", zone: "Zone B", time: "18:40", salle: "Salle CYE 1" },
  { n: 22, olm: "JCI INSAT Tunis", participant: "Oussama Ben Abdessalem", startup: "Carbon Jar", zone: "Zone A", time: "18:40", salle: "Salle CYE 2" },
  { n: 23, olm: "JCI Menzel Jemil", participant: "Fehmi Kharroubi", startup: "ExypnoTech Engineering Services", zone: "Zone B", time: "18:50", salle: "Salle CYE 1" },
  { n: 24, olm: "JCI Menzel Jemil", participant: "Jawher Makhlouf", startup: "NaturAdds", zone: "Zone B", time: "18:50", salle: "Salle CYE 2" },
  { n: 25, olm: "JCI Tanyour", participant: "Ghazi Mhiri", startup: "Ecocode", zone: "Zone E", time: "19:00", salle: "Salle CYE 1" },
  { n: 26, olm: "JCI Carthage", participant: "Mariem Bouzekri", startup: "DDMLABS", zone: "Zone A", time: "19:00", salle: "Salle CYE 2" },
];
...
const samediPresentiel: PassageEntry[] = [
  ...
  { n: 4, olm: "JCI Feriana", participant: "Dorra Hermassi", startup: "ArtisanArt chez Hermassi", zone: "Zone D", time: "10:10", salle: "Salle CYE 2" },
  { n: 5, olm: "JCI Diwan", participant: "Rafik Gharbi", startup: "Dootify", zone: "Zone E", time: "10:20", salle: "Salle CYE 1" },
  { n: 6, olm: "JCI Hajeb Laayoun", participant: "Abdelhak Abbassi", startup: "AgroNoya", zone: "Zone D", time: "10:20", salle: "Salle CYE 2" },
  { n: 7, olm: "JCI Bizerte", participant: "Kawther Mekni", startup: "K Sustainova Consulting — Lysitek 4 GPM", zone: "Zone B", time: "10:30", salle: "Salle CYE 1" },
  ...
  { n: 16, olm: "JCI Zarzouna", participant: "Mustapha Zoghlami", startup: "El Makina Digital", zone: "Zone B", time: "11:20", salle: "Salle CYE 1" },
  { n: 17, olm: "JCI El Manzah", participant: "Ismail Ben Salah", startup: "Omni Links TN", zone: "Zone A", time: "11:20", salle: "Salle CYE 2" },
  { n: 18, olm: "JCI Gremda", participant: "Ahmed Walha", startup: "Dashmaster", zone: "Zone E", time: "11:30", salle: "Salle CYE 1" },
  { n: 19, olm: "JCI Ksar Saïd", participant: "Mohamed Ghaith Welhezi", startup: "WIHELP", zone: "Zone A", time: "11:30", salle: "Salle CYE 2" },
  { n: 20, olm: "JCI TBS El Mourouj", participant: "Khalil Jbeniani", startup: "Allcarta", zone: "Zone A", time: "11:40", salle: "Salle CYE 1" },
  { n: 21, olm: "JCI Bousalem", participant: "Fahd Hanachi", startup: "The Denim Dilemma", zone: "Zone B", time: "11:40", salle: "Salle CYE 2" },
  { n: 22, olm: "JCI Menzel Jemil", participant: "Seif Eddine Ben Amara", startup: "Founder.tn", zone: "Zone B", time: "11:50", salle: "Salle CYE 1" },
  { n: 23, olm: "JCI Jardins El Mourouj", participant: "Khouloud Ayachi", startup: "MEPS", zone: "Zone A", time: "11:50", salle: "Salle CYE 2" },
  { n: 24, olm: "JCI Mornaguia", participant: "Aymen Masmoudi", startup: "LR Move", zone: "Zone A", time: "12:00", salle: "Salle CYE 1" },
  { n: 25, olm: "JCI El Jem", participant: "Ghada Mejri", startup: "ECOMARC", zone: "Zone C", time: "12:00", salle: "Salle CYE 2" },
  { n: 26, olm: "JCI Mateur", participant: "Madiha Chiboub", startup: "Camomille", zone: "Zone B", time: "13:10", salle: "Salle CYE 1" },
  { n: 27, olm: "JCI Zarzis", participant: "Gabaji Marwan", startup: "Galaxy Talents", zone: "Zone E", time: "13:10", salle: "Salle CYE 2" },
  { n: 28, olm: "JCI Bousalem", participant: "Dhouha Jbeli", startup: "MIELVITA", zone: "Zone B", time: "13:20", salle: "Salle CYE 1" },
  { n: 29, olm: "JCI Kelibia", participant: "Youssef Ben Ahmed", startup: "Study Space", zone: "Zone A", time: "13:20", salle: "Salle CYE 2" },
  { n: 30, olm: "JCI Tunis", participant: "Adnen Ben Haj Yhahia", startup: "Indinya", zone: "Zone A", time: "13:30", salle: "Salle CYE 1" },
  { n: 31, olm: "JCI Enig Gabes Sud", participant: "Seif Ben Romdhane", startup: "Octopus Agency", zone: "Zone E", time: "13:40", salle: "Salle CYE 1" },
  { n: 32, olm: "JCI Medenine", participant: "Rihab Kadi", startup: "Dukan", zone: "Zone E", time: "13:40", salle: "Salle CYE 2" },
  { n: 33, olm: "JCI Djerba Midoun", participant: "Roua Jebabli", startup: "ROSNÉ", zone: "Zone E", time: "13:50", salle: "Salle CYE 1" },
  { n: 34, olm: "JCI Université Jendouba", participant: "Boubakri Dhia Eddine", startup: "Ettaba Kids (Seedo)", zone: "Zone B", time: "13:50", salle: "Salle CYE 2" },
  { n: 35, olm: "JCI Hammam Chatt", participant: "Iyed Ben Massoud", startup: "AIO Events", zone: "Zone A", time: "14:00", salle: "Salle CYE 1" },
  { n: 36, olm: "JCI Siliana", participant: "Oussama Dhrif", startup: "OBL-X Smart Solutions", zone: "Zone B", time: "14:00", salle: "Salle CYE 2" },
  { n: 37, olm: "JCI Gremda", participant: "Ali Bel Hajsalah", startup: "Kidora IA", zone: "Zone E", time: "14:10", salle: "Salle CYE 1" },
];
